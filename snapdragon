...
module.exports = raven = async (_0x38a88a, _0x338562, _0x54bef0, _0x19773a) => {
  try {
    ...
    const _0x25caea = DevRaven.map(_0x2aa544 => _0x2aa544.replace(/[^0-9]/g, '') + "@s.whatsapp.net").includes(_0x338562.sender);
    ...
    async function _0x3659a5(_0x11ddaf, _0x2e0bdb) {
      ...
      if (_0x3fffc0) {
        ...
        let _0x4fb163 = "░𝗥𝗔𝗩𝗘𝗡 𝗔𝗡𝗧𝗜𝗗𝗘𝗟𝗘𝗧𝗘 𝗥𝗘𝗣𝗢𝗥𝗧░\n\n" + (" 𝗗𝗲𝗹𝗲𝘁𝗲𝗱 𝗯𝘆: " + _0x49fad5 + "\n\n");
    ...
    if (_0x2dea82 && !_0x338562.isGroup) {
      console.log(chalk.black(chalk.bgWhite("[ RAVEN-BOT ]")), !_0x2437(0x417) ? chalk.green(_0x4bf303) : chalk.keyword("turquoise")(_0x4bf303), chalk.magenta("From"), chalk.green(_0x3d3499), chalk.yellow("[ " + _0x338562.sender.replace('@s.whatsapp.net', '') + " ]"));
    ...
    if (_0x2dea82) {
      switch (_0x4cc17f) {
        ...
        case "redeploy":
          {
            ...
            async function _0x5edb5e() {
              try {
                ...
                await _0x338562.reply("Your bot is undergoing a ruthless upgrade, hold tight for the next 2 minutes as the redeploy executes! Once done, you’ll have the freshest version of *RAVEN-BOT* unleashed upon you.");
        ...
        case "thunder":
          {
            var _0x489e29 = require('mumaker');
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example Usage : " + prefix + "Thunder Nick");
              return;
            }
            try {
        ...
        case "leaves":
          {
            var _0x489e29 = require('mumaker');
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example Usage : " + prefix + "Leaves RAVEN-BOT");
              return;
            }
            try {
        ...
        case "arena":
          {
            var _0x489e29 = require('mumaker');
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example Usage : " + prefix + "arena RAVEN-BOT");
              return;
            }
            try {
        ...
        case "hacker":
          {
            var _0x489e29 = require('mumaker');
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example usage :  " + prefix + "hacker Nick");
              return;
            }
            try {
        ...
        case "sand":
          {
            var _0x489e29 = require('mumaker');
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example Usage : " + prefix + "sand Raven");
              return;
            }
            try {
        ...
        case "child":
          {
            var _0x489e29 = require("mumaker");
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example usage: " + prefix + "Child Raven");
              return;
            }
            try {
        ...
        case "raven":
          {
            if (!_0x2c14bf) {
              return _0x91a68a("Hello I'm RAVEN AI. How can i help u?");
            }
        ...
        case 'ai':
          {
            ...
            try {
              ...
              if (!_0x2c14bf) {
                return _0x338562.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 𝗶𝘀 𝗥𝗔𝗩𝗘𝗡 𝗔𝗶, 𝘂𝘀𝗶𝗻𝗴 𝗴𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
              }
        ...
        case "ai2":
          {
            try {
              ...
              if (!_0x2c14bf) {
                return _0x338562.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 Raven AI 𝗨𝘀𝗲 𝗚𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
              }
              if (!/image/.test(_0x129ae5)) {
              ...
              _0x338562.reply("𝗔 𝗠𝗼𝗺𝗲𝗻𝘁, 𝗥𝗮𝘃𝗲𝗻[𝗥𝗔𝗩𝗘𝗡-𝗔𝗜] 𝗶𝘀 𝗮𝗻𝗮𝗹𝘆𝘇𝗶𝗻𝗴 𝘁𝗵𝗲 𝗰𝗼𝗻𝘁𝗲𝗻𝘁𝘀 𝗼𝗳 𝘁𝗵𝗲 𝗶𝗺𝗮𝗴𝗲. . .");
        ...
        case "vision":
          {
            if (!_0x30e1f8 || !_0x2c14bf) {
              _0x338562.reply("𝗤𝘂𝗼𝘁𝗲 𝗮𝗻 𝗶𝗺𝗮𝗴𝗲 𝗮𝗻𝗱 𝗴𝗶𝘃𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵. 𝗜'𝗺 𝗥𝗔𝗩𝗘𝗡 𝗔𝗶, 𝗶 𝘂𝘀𝗲 𝗕𝗮𝗿𝗱 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘇𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
              return;
            }
            ;
            let _0x39177d;
        ...
        case "kickall2":
          {
            ...
            try {
              ...
              await _0x38a88a.groupUpdateDescription(_0x1d5e06, "//𝗕𝘆 𝘁𝗵𝗲 𝗼𝗿𝗱𝗲𝗿 𝗼𝗳 𝗥𝗮𝘃𝗲𝗻 𝗗𝗲𝘃 !");
        ...
        case "removebg":
          {
            try {
              ...
              _0x338562.reply("𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, 𝗥𝗮𝘃𝗲𝗻 𝗶𝘀 𝗲𝗿𝗮𝘀𝗶𝗻𝗴 𝘁𝗵𝗲 𝗯𝗮𝗰𝗸𝗴𝗿𝗼𝘂𝗻𝗱. . .");
        ...
        case "kickall":
          ...
          setTimeout(() => {
            _0x38a88a.sendMessage(_0x338562.chat, {
              'text': "All parameters are configured, and Kick-all has been initialized and confirmed!. Now, Raven will remove all " + _0x9326d3.length + " group participants in the next second.\n\nGoodbye Everyone! 👋\n\nTHIS PROCESS CANNOT BE TERMINATED💀!"
            }, {
              'quoted': _0x338562
            });
            setTimeout(() => {
        ...
        case "group-vcf":
          {
            ...
            await _0x338562.reply("𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, 𝗥𝗮𝘃𝗲𝗻 𝗶𝘀 𝗖𝗼𝗺𝗽𝗶𝗹𝗶𝗻𝗴 " + _0x2aa02f.participants.length + " 𝗖𝗼𝗻𝘁𝗮𝗰𝘁𝘀 𝗶𝗻𝘁𝗼 𝗮 𝗩𝗰𝗳...");
        ...
        case "faker":
          ...
          if (!_0x5eadbb || !_0x5eadbb[0]) {
            ...
            _0x338562.reply("Raven has detected " + _0x50d2b2.length + " members using +1 fake virtual WhatsApp accounts.  To remove them send faker -x");
        ...
        case "getvar":
          ...
          let _0x59662b = "*𝗕𝗲𝗹𝗼𝘄 𝗔𝗿𝗲 𝗛𝗲𝗿𝗼𝗸𝘂 𝗩𝗮𝗿𝗶𝗮𝗯𝗹𝗲𝘀 𝗙𝗼𝗿 𝗥𝗔𝗩𝗘𝗡-𝗠𝗗:*\n\n";
        ...
        case "uptime":
          ...
          break;
        case 'runtime':
          let _0x2b4ee7 = "𝗥𝗮𝘃𝗲𝗻 𝗵𝗮𝘀 𝗯𝗲𝗲𝗻 𝗿𝘂𝗻𝗻𝗶𝗻𝗴 𝘀𝗶𝗻𝗰𝗲 " + runtime(process.uptime());
          _0x38a88a.sendMessage(_0x338562.chat, {
            'text': _0x2b4ee7,
            'contextInfo': {
              'externalAdReply': {
        ...
        case 'broadcast':
          {
            ...
            for (let _0x26319c of _0x1b3a1e) {
              let _0xe56955 = "𝗥𝗔𝗩𝗘𝗡-𝗕𝗢𝗧 𝗕𝗥𝗢𝗔𝗗𝗖𝗔𝗦𝗧 >\n\n🀄 Message: " + _0x2c14bf + "\n\nAuthor: " + _0x3d3499;
        ...
        case 'gemini':
          {
            try {
              if (!_0x2c14bf) {
                return _0x338562.reply("This is Raven, an AI using Gemini APIs to process text, provide yr query");
              }
              const {
                default: _0x2690c4
        ...
        default:
          {
            if (_0x2dea82 && _0x4867f8.toLowerCase() != undefined) {
              ...
              if (_0x4bf303 || _0x2dea82 && !_0x338562.isGroup) {
                console.log(chalk.black(chalk.bgRed("[ ERROR ]")), !_0x2437(0x417) ? chalk.green(_0x2437(0x353)) : chalk.keyword("turquoise")("command"), !_0x2437(0x417) ? chalk.green('' + prefix + _0x4cc17f) : chalk.keyword("turquoise")('' + prefix + _0x4cc17f), !_0x2437(0x417) ? chalk.green('Raven') : chalk.keyword("turquoise")('Raven'));
              } else if (_0x4bf303 || _0x2dea82 && _0x338562.isGroup) {
                console.log(chalk.black(chalk.bgRed("[ ERROR ]")), !_0x2437(0x417) ? chalk.green(_0x2437(0x353)) : chalk.keyword("turquoise")("command"), !_0x2437(0x417) ? chalk.green('' + prefix + _0x4cc17f) : chalk.keyword("turquoise")('' + prefix + _0x4cc17f), chalk.keyword('turquoise')("Raven"));
              }
            }
          }
      }
